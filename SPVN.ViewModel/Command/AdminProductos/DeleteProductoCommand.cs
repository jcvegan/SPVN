...
{
    public class DeleteProductoCommand:ICommand
    {
        AdminProductosViewModel viewModel;

        public DeleteProductoCommand(AdminProductosViewModel _admin)
        {
            viewModel = _admin;
        }
        ...
        {
            viewModel.EliminarProducto(parameter as T_Producto);
        }
    }
}
