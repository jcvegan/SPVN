...
namespace SPVN.App.Web
{
    ...
    public sealed partial class AuthenticationContext : global::System.ServiceModel.DomainServices.Client.ApplicationServices.AuthenticationDomainContextBase
    {
        ...
        public AuthenticationContext() : 
                this(new WebDomainClient<IAuthenticationServiceContract>(new Uri("SPVN-App-Web-AuthenticationService.svc", UriKind.Relative)))
        {
        }
    ...
    /// </summary>
    [DataContract(Namespace="http://schemas.datacontract.org/2004/07/SPVN.App.Web")]
    public sealed partial class RegistrationData : Entity
    {
        ...
        // 
        // - The attribute 'System.ComponentModel.DataAnnotations.RequiredAttribute' references type 'SPVN.App.Web.Resources.ValidationErrorResources' that is not accessible in the client project 'SPVN.App.csproj'. Are you missing an assembly reference?
        // - The attribute 'System.ComponentModel.DataAnnotations.RequiredAttribute' references a property 'ValidationErrorRequiredField' on type 'SPVN.App.Web.Resources.ValidationErrorResources' that is not accessible in the client project 'SPVN.App.csproj'.
        // [RequiredAttribute(ErrorMessageResourceName = "ValidationErrorRequiredField", ErrorMessageResourceType = typeof(SPVN.App.Web.Resources.ValidationErrorResources))]
        // 
        [DataMember()]
        [Display(Name="SecurityAnswerLabel", Order=6, ResourceType=typeof(SPVN.App.Web.Resources.RegistrationDataResources))]
        ...
        // Unable to generate the following attribute(s) due to the following error(s):
        // 
        // - The attribute 'System.ComponentModel.DataAnnotations.RegularExpressionAttribute' references type 'SPVN.App.Web.Resources.ValidationErrorResources' that is not accessible in the client project 'SPVN.App.csproj'. Are you missing an assembly reference?
        // - The attribute 'System.ComponentModel.DataAnnotations.RegularExpressionAttribute' references a property 'ValidationErrorInvalidEmail' on type 'SPVN.App.Web.Resources.ValidationErrorResources' that is not accessible in the client project 'SPVN.App.csproj'.
        // [RegularExpressionAttribute("^([\w-\.]+)@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.)|(([\w-]+\.)+))([a-zA-Z]{2,4}|[0-9]{1,3})(\]?)$", ErrorMessageResourceName = "ValidationErrorInvalidEmail", ErrorMessageResourceType = typeof(SPVN.App.Web.Resources.ValidationErrorResources))]
        // 
        // - The attribute 'System.ComponentModel.DataAnnotations.RequiredAttribute' references type 'SPVN.App.Web.Resources.ValidationErrorResources' that is not accessible in the client project 'SPVN.App.csproj'. Are you missing an assembly reference?
        // - The attribute 'System.ComponentModel.DataAnnotations.RequiredAttribute' references a property 'ValidationErrorRequiredField' on type 'SPVN.App.Web.Resources.ValidationErrorResources' that is not accessible in the client project 'SPVN.App.csproj'.
        // [RequiredAttribute(ErrorMessageResourceName = "ValidationErrorRequiredField", ErrorMessageResourceType = typeof(SPVN.App.Web.Resources.ValidationErrorResources))]
        // 
        [DataMember()]
        [Display(Name="EmailLabel", Order=2, ResourceType=typeof(SPVN.App.Web.Resources.RegistrationDataResources))]
        ...
        // Unable to generate the following attribute(s) due to the following error(s):
        // 
        // - The attribute 'System.ComponentModel.DataAnnotations.StringLengthAttribute' references type 'SPVN.App.Web.Resources.ValidationErrorResources' that is not accessible in the client project 'SPVN.App.csproj'. Are you missing an assembly reference?
        // - The attribute 'System.ComponentModel.DataAnnotations.StringLengthAttribute' references a property 'ValidationErrorBadFriendlyNameLength' on type 'SPVN.App.Web.Resources.ValidationErrorResources' that is not accessible in the client project 'SPVN.App.csproj'.
        // [StringLengthAttribute(255, ErrorMessageResourceName = "ValidationErrorBadFriendlyNameLength", ErrorMessageResourceType = typeof(SPVN.App.Web.Resources.ValidationErrorResources))]
        // 
        [DataMember()]
        [Display(Description="FriendlyNameDescription", Name="FriendlyNameLabel", Order=1, ResourceType=typeof(SPVN.App.Web.Resources.RegistrationDataResources))]
        ...
        // 
        [DataMember()]
        [Display(Name="SecurityQuestionLabel", Order=5, ResourceType=typeof(SPVN.App.Web.Resources.RegistrationDataResources))]
        ...
        // 
        // - The attribute 'System.ComponentModel.DataAnnotations.RegularExpressionAttribute' references type 'SPVN.App.Web.Resources.ValidationErrorResources' that is not accessible in the client project 'SPVN.App.csproj'. Are you missing an assembly reference?
        // - The attribute 'System.ComponentModel.DataAnnotations.RegularExpressionAttribute' references a property 'ValidationErrorInvalidUserName' on type 'SPVN.App.Web.Resources.ValidationErrorResources' that is not accessible in the client project 'SPVN.App.csproj'.
        // [RegularExpressionAttribute("^[a-zA-Z0-9_]*$", ErrorMessageResourceName = "ValidationErrorInvalidUserName", ErrorMessageResourceType = typeof(SPVN.App.Web.Resources.ValidationErrorResources))]
        // 
        // - The attribute 'System.ComponentModel.DataAnnotations.RequiredAttribute' references type 'SPVN.App.Web.Resources.ValidationErrorResources' that is not accessible in the client project 'SPVN.App.csproj'. Are you missing an assembly reference?
        // - The attribute 'System.ComponentModel.DataAnnotations.RequiredAttribute' references a property 'ValidationErrorRequiredField' on type 'SPVN.App.Web.Resources.ValidationErrorResources' that is not accessible in the client project 'SPVN.App.csproj'.
        // [RequiredAttribute(ErrorMessageResourceName = "ValidationErrorRequiredField", ErrorMessageResourceType = typeof(SPVN.App.Web.Resources.ValidationErrorResources))]
        // 
        // - The attribute 'System.ComponentModel.DataAnnotations.StringLengthAttribute' references type 'SPVN.App.Web.Resources.ValidationErrorResources' that is not accessible in the client project 'SPVN.App.csproj'. Are you missing an assembly reference?
        // - The attribute 'System.ComponentModel.DataAnnotations.StringLengthAttribute' references a property 'ValidationErrorBadUserNameLength' on type 'SPVN.App.Web.Resources.ValidationErrorResources' that is not accessible in the client project 'SPVN.App.csproj'.
        // [StringLengthAttribute(255, ErrorMessageResourceName = "ValidationErrorBadUserNameLength", ErrorMessageResourceType = typeof(SPVN.App.Web.Resources.ValidationErrorResources), MinimumLength = 4)]
        // 
        [DataMember()]
        [Display(Name="UserNameLabel", Order=0, ResourceType=typeof(SPVN.App.Web.Resources.RegistrationDataResources))]
        [Editable(false, AllowInitialValue=true)]
        [Key()]
        [RoundtripOriginal()]
    ...
    public sealed partial class UserRegistrationContext : DomainContext
    {
        ...
        public UserRegistrationContext() : 
                this(new WebDomainClient<IUserRegistrationServiceContract>(new Uri("SPVN-App-Web-UserRegistrationService.svc", UriKind.Relative)))
        {
        }
        ...
        // 
        // - The attribute 'System.ComponentModel.DataAnnotations.RegularExpressionAttribute' references type 'SPVN.App.Web.Resources.ValidationErrorResources' that is not accessible in the client project 'SPVN.App.csproj'. Are you missing an assembly reference?
        // - The attribute 'System.ComponentModel.DataAnnotations.RegularExpressionAttribute' references a property 'ValidationErrorBadPasswordStrength' on type 'SPVN.App.Web.Resources.ValidationErrorResources' that is not accessible in the client project 'SPVN.App.csproj'.
        // [RegularExpressionAttribute("^.*[^a-zA-Z0-9].*$", ErrorMessageResourceName = "ValidationErrorBadPasswordStrength", ErrorMessageResourceType = typeof(SPVN.App.Web.Resources.ValidationErrorResources))]
        // 
        // - The attribute 'System.ComponentModel.DataAnnotations.RequiredAttribute' references type 'SPVN.App.Web.Resources.ValidationErrorResources' that is not accessible in the client project 'SPVN.App.csproj'. Are you missing an assembly reference?
        // - The attribute 'System.ComponentModel.DataAnnotations.RequiredAttribute' references a property 'ValidationErrorRequiredField' on type 'SPVN.App.Web.Resources.ValidationErrorResources' that is not accessible in the client project 'SPVN.App.csproj'.
        // [RequiredAttribute(ErrorMessageResourceName = "ValidationErrorRequiredField", ErrorMessageResourceType = typeof(SPVN.App.Web.Resources.ValidationErrorResources))]
        // 
        // - The attribute 'System.ComponentModel.DataAnnotations.StringLengthAttribute' references type 'SPVN.App.Web.Resources.ValidationErrorResources' that is not accessible in the client project 'SPVN.App.csproj'. Are you missing an assembly reference?
        // - The attribute 'System.ComponentModel.DataAnnotations.StringLengthAttribute' references a property 'ValidationErrorBadPasswordLength' on type 'SPVN.App.Web.Resources.ValidationErrorResources' that is not accessible in the client project 'SPVN.App.csproj'.
        // [StringLengthAttribute(50, ErrorMessageResourceName = "ValidationErrorBadPasswordLength", ErrorMessageResourceType = typeof(SPVN.App.Web.Resources.ValidationErrorResources), MinimumLength = 7)]
        // 
